...
docker build -t dd-flask-demo:latest ./app
...
kubectl rollout status deployment/dd-flask-demo -n "$NAMESPACE" --timeout=60s

echo ""
echo "Setup complete! To access the app:"
echo "  kubectl port-forward -n $NAMESPACE svc/dd-flask-demo 8080:8080"
